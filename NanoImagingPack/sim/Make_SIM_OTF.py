# -*- coding: utf-8 -*-
"""
Created on Wed Jun 27 18:51:35 2018
...
def make_sim_otf(OTF, k_vec, dir_vec, variance_vec, pxs, orderstrength, method = 'sum'):
    ...
    px_converter = nip.px_freq_step(otf, pxs);  # conversion factro for k ->pixel
    ...
    for alpha in enumerate(dir_vec):
        for k in enumerate(k_vec):
            ...
            shifted_otfs = nip.cat((shifted_otfs, nip.shift(OTF*orderstrength[k[0]][alpha[0]], shift_vec)),2);
